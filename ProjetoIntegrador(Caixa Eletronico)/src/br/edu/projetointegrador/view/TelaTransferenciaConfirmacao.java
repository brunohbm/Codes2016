 ...
 * @author CrasyFox
 */
public class TelaTransferenciaConfirmacao extends javax.swing.JFrame {

    Operacao operacao = new Operacao();
    
    public TelaTransferenciaConfirmacao(Operacao operacao) {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaTransferenciaConfirmacao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
